package com.ishidai.ischedule.task.service;
...
import com.ishidai.ischedule.task.QuartzJobFactory;
import com.ishidai.ischedule.task.QuartzJobFactoryDisallowConcurrentExecution;
import com.ishidai.ischedule.task.dao.ScheduleJobDao;
...
public class JobTaskService {
     ...
     * @param extParams
     */
    public void updateExtParams(Long jobId, String extParams) {
        ScheduleJob job = getTaskById(jobId);
        if (job == null) {
            return;
        }
